    ...
    public class MapLoader : MonoBehaviour
    {
        ...
        IEnumerator SpawnAfterDelay()
        {
            ...
            try
            {
                ...
                // Collect materials from scene's own renderers BEFORE clearing
                // (scene-specific; won't pollute with weapon/Christmas asset mats)
                ...
                foreach (MapObjData obj in items)
                {
                    ...
                    // Apply material: scene cache → disk PNG → color tint
                ...
                ModEntry.Log("MapLoader: spawned " + spawned + " objects");
