...
namespace CNRZombieMod
{
    ...
    public class ZombieHook : MonoBehaviour
    {
        ...
        private static readonly System.Collections.Generic.Dictionary<string, Rect> ENEMY_REMAP =
            new System.Collections.Generic.Dictionary<string, Rect>(StringComparer.OrdinalIgnoreCase)
        {
            {"blood", new Rect(17f/64f, 22f/32f, 10f/64f, 1f/32f)},
            {"head_front", new Rect(0f/64f, 0f/32f, 8f/64f, 5f/32f)},
            {"head_right", new Rect(8f/64f, 0f/32f, 8f/64f, 5f/32f)},
            {"head_left", new Rect(16f/64f, 0f/32f, 8f/64f, 5f/32f)},
            {"head_back", new Rect(24f/64f, 0f/32f, 8f/64f, 5f/32f)},
            {"head_top", new Rect(32f/64f, 0f/32f, 8f/64f, 5f/32f)},
            {"head_bottom", new Rect(40f/64f, 0f/32f, 8f/64f, 5f/32f)},
            {"torso_front", new Rect(0f/64f, 6f/32f, 8f/64f, 6f/32f)},
            {"torso_back", new Rect(8f/64f, 6f/32f, 8f/64f, 6f/32f)},
            {"torso_left", new Rect(16f/64f, 6f/32f, 4f/64f, 6f/32f)},
            {"torso_right", new Rect(20f/64f, 6f/32f, 4f/64f, 6f/32f)},
            {"torso_top", new Rect(24f/64f, 6f/32f, 8f/64f, 4f/32f)},
            {"torso_bottom", new Rect(32f/64f, 6f/32f, 8f/64f, 4f/32f)},
            {"right_arm_front", new Rect(40f/64f, 6f/32f, 4f/64f, 7f/32f)},
            {"right_arm_right", new Rect(44f/64f, 6f/32f, 4f/64f, 7f/32f)},
            {"right_arm_left", new Rect(48f/64f, 6f/32f, 4f/64f, 7f/32f)},
            {"right_arm_back", new Rect(52f/64f, 6f/32f, 4f/64f, 7f/32f)},
            {"right_arm_top", new Rect(56f/64f, 6f/32f, 4f/64f, 3f/32f)},
            {"right_arm_bottom", new Rect(56f/64f, 9f/32f, 4f/64f, 3f/32f)},
            {"left_arm_front", new Rect(40f/64f, 12f/32f, 4f/64f, 7f/32f)},
            {"left_arm_right", new Rect(44f/64f, 12f/32f, 4f/64f, 7f/32f)},
            {"left_arm_left", new Rect(48f/64f, 12f/32f, 4f/64f, 7f/32f)},
            {"left_arm_back", new Rect(52f/64f, 12f/32f, 4f/64f, 7f/32f)},
            {"left_arm_top", new Rect(56f/64f, 12f/32f, 4f/64f, 3f/32f)},
            {"left_arm_bottom", new Rect(56f/64f, 15f/32f, 4f/64f, 3f/32f)},
            {"right_leg_front", new Rect(0f/64f, 19f/32f, 4f/64f, 7f/32f)},
            {"right_leg_right", new Rect(4f/64f, 19f/32f, 4f/64f, 7f/32f)},
            {"right_leg_left", new Rect(8f/64f, 19f/32f, 4f/64f, 7f/32f)},
            {"right_leg_back", new Rect(12f/64f, 19f/32f, 4f/64f, 7f/32f)},
            {"right_leg_top", new Rect(16f/64f, 19f/32f, 4f/64f, 3f/32f)},
            {"right_leg_bottom", new Rect(16f/64f, 22f/32f, 4f/64f, 3f/32f)},
            {"left_leg_front", new Rect(20f/64f, 19f/32f, 4f/64f, 7f/32f)},
            {"left_leg_right", new Rect(24f/64f, 19f/32f, 4f/64f, 7f/32f)},
            {"left_leg_left", new Rect(28f/64f, 19f/32f, 4f/64f, 7f/32f)},
            {"left_leg_back", new Rect(32f/64f, 19f/32f, 4f/64f, 7f/32f)},
            {"left_leg_top", new Rect(36f/64f, 19f/32f, 4f/64f, 3f/32f)},
            {"left_leg_bottom", new Rect(36f/64f, 22f/32f, 4f/64f, 3f/32f)},
        };
        ...
        private static void ApplyZombieSkin(GameObject go, int variant)
        {
            ...
            for (int i = 0; i < renderers.Length; i++)
            {
                ...
                m.mainTexture = tex;
                if (LooksLikeEnemyHealthBar(r.transform))
                    SetBloodBarAtlasRegion(m, tex.width, tex.height);
                r.material = m;
            }
        }
        ...
        private static void SetBloodBarAtlasRegion(Material m, int texWidth, int texHeight)
        {
            if (m == null || texWidth <= 0 || texHeight <= 0) return;
            const float x = 17f;
            const float y = 22f;
            const float w = 10f;
            const float h = 1f;
            m.mainTextureOffset = new Vector2((x + w) / texWidth, (y + h) / texHeight);
            m.mainTextureScale = new Vector2(-w / texWidth, -h / texHeight);
        }
        ...
        private GameObject FindEnemy3DumpRoot()
        {
            try
            {
                UnityEngine.Object[] all = UnityEngine.Object.FindObjectsOfType(typeof(GameObject));
        ...
        private void KillZombie(byte id, GameObject go)
        {
            ...
            // Increment the local player's vanilla kill counter so it shows on the scoreboard.
            try
            {
        ...
        private static void RemapEnemyAtlas(GameObject go)
        {
            ...
            for (int i = 0; i < renderers.Length; i++)
            {
                Renderer r = renderers[i];
                if (r == null) continue;
                string key = r.gameObject != null ? r.gameObject.name : null;
                if (string.IsNullOrEmpty(key) || !ENEMY_REMAP.ContainsKey(key)) continue;
                ...
                Rect rect = ENEMY_REMAP[key];
                Vector2[] remapped = new Vector2[uv.Length];
                for (int j = 0; j < uv.Length; j++)
                {
                    remapped[j] = new Vector2(rect.x + uv[j].x * rect.width, rect.y + uv[j].y * rect.height);
                }
                mesh.uv = remapped;
            }
        }
        ...
        public void OnZombieEvent(EventData ev)
        {
            try
            {
                ...
                if (ht.ContainsKey("zs"))
                    ApplySyncedModeState(ht["zs"] as float[]);
