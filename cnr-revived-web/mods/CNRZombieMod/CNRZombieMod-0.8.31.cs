    ...
    public class ZombieDriver : MonoBehaviour
    {
        ...
        private void AddRemotePlayerTargets(Vector3 zombiePos, ref PlayerTarget best, ref float bestSq)
        {
            try
            {
                ...
                FieldInfo objField = mgrType.GetField("otherPlayerObject", BindingFlags.Public | BindingFlags.Instance);
                FieldInfo infoField = mgrType.GetField("otherPlayersInfoList", BindingFlags.Public | BindingFlags.Instance);
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    FieldInfo idField = infoType.GetField("mId", BindingFlags.Public | BindingFlags.Instance);
