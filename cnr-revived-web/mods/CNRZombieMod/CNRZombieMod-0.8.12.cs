...
namespace CNRZombieMod
{
    ...
    public class ZombieHook : MonoBehaviour
    {
        ...
        private void ApplyZombieDamageRequest(object raw)
        {
            ...
            byte id = (byte)Mathf.Clamp(req[0], 0, 250);
            int dmg = Mathf.Max(1, req[1]);
            ApplyZombieDamage(id, dmg);
        }

        private void ApplyZombieDamage(byte id, int damage)
        {
            ZombieDriver drv;
