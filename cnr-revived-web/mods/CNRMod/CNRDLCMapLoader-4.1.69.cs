...
namespace CNRMods
{
    ...
    internal class CNRDLCMapLoader : MonoBehaviour
    {
        ...
        {
            // Use controlled, low-cost lighting for DLC geometry instead of inheriting
            // whatever the donor scene happened to use. Ambient keeps deep recesses
            // readable, while the stronger angled key gives each block face a distinct
            // value so holes, corners and ledges have visible depth without realtime
            // shadow maps on this old mobile renderer.
            RenderSettings.ambientLight = new Color(0.27f, 0.27f, 0.27f, 1f);
