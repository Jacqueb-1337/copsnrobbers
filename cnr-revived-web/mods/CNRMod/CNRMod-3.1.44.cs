    ...
    public class ContentManager : MonoBehaviour
    {
        ...
        static void EnsureDirs()
        {
            try
            {
                ...
                // Without this the scanner can modify PNG files, causing MD5 mismatches on restart.
                string nomedia = "/storage/emulated/0/CNRMods/content_cache/.nomedia";
                if (!File.Exists(nomedia))
                    try { File.WriteAllBytes(nomedia, new byte[0]); } catch {}
            }
