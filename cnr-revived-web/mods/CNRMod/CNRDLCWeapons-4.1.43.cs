...
namespace CNRMods
{
    ...
    {
        private const string ThumbnailFile = "bussin_thumb_v2.png";
        private const string ThumbnailHashPref = "CNR_BussinThumbHashV2";
        ...
        private static Texture2D RenderThumbnail(string path, string modelHash)
        {
            ...
            try
            {
                ...
                preview.transform.localRotation = Quaternion.Euler(5f, 180f, -3f);
    ...
    public class CNRDLCWeaponRuntime : MonoBehaviour
    {
        ...
        private void ApplyBussinRecoil()
        {
            ...
            velocity += -cam.transform.forward.normalized * BussinRecoilVelocity;
            fps.SetVelocity(velocity);
            ModEntry.Log("CNR DLC weapons: Bussin' recoil impulse " + (-cam.transform.forward.normalized * BussinRecoilVelocity));
        }
        ...
        private void AttachBussinModel(WeaponScript ws)
        {
            ...
            try
            {
                ...
                // The Sketchfab model's muzzle points opposite the donor's local
                // forward direction, so turn it around before fitting it.
                _customModel.transform.localRotation = Quaternion.Euler(0f, 180f, 0f);
