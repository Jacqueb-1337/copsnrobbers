...
namespace CNRMods
{
    ...
    public class ModEntry
    {
        ...
        public const  string Version = "3.2.17";
        ...
        private static string ResolvePeerName(Type mgrType, object mgr, string peerId, System.Array others)
        {
            string nick = null;
