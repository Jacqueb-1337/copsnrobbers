...
namespace CNRMods
{
    ...
    public class ModEntry
    {
        ...
        public const  string Version = "3.2.40";
    ...
    public class CNRSkinGridUI : MonoBehaviour
    {
        ...
        System.Collections.IEnumerator RenderThumbs()
        {
            ...
            if (renderers.Length == 0) { _thumbsReady = true; if (!wasActive) modelGO.SetActive(false); yield break; }
            ...
            // Position: front-right 3/4 angle, framing full body
            Vector3 center = b.center;
            float   halfH  = b.size.y * 0.55f;
            float   dist   = b.size.y * 1.6f;
            Vector3 dir    = (modelGO.transform.forward * -1f +
                              modelGO.transform.right   *  0.4f).normalized;
            camGO.transform.position = center + dir * dist + Vector3.up * (b.size.y * 0.05f);
