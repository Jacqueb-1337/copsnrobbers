...
namespace CNRMods
{
    ...
    public class CNRBussinRemoteWeaponRenderer : MonoBehaviour
    {
        ...
        private void EnsureVisual(int actorId)
        {
            ...
            {
                if (existing.ActorObject == actor && existing.CustomModel != null) return;
                RemoveVisual(actorId);
            }
    ...
    public class CNRDLCWeaponRuntime : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            CNRBussinNetworkState.LocalVisualLevel = bussinSelected
        ...
        private void ApplyBussinAmmoLevel(WeaponScript ws)
        {
            ...
            ws.ShotGun.fractions = 5;
            // Keep the Bussin' deliberately slower to reload than its donor, but not quite
            // as punishing as the old 2x duration. 1.75x duration is ~14% faster than before.
            ws.ShotGun.reloadTime = Mathf.Max(0.1f, ws.ShotGun.reloadTime * 1.75f);
