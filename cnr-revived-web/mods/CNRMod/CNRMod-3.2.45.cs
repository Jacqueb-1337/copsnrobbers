...
namespace CNRMods
{
    ...
    public class ModEntry
    {
        ...
        public const  string Version = "3.2.45";
    ...
    public class CNRSkinStoreHook : MonoBehaviour, ICNRSkinHook
    {
        ...
        void UpdatePreviewLabels(int idx)
        {
            ...
            if (nameLbl != null) { nameLbl.gameObject.SetActive(true); nameLbl.enabled = true; nameLbl.text = info.mNameDisplay ?? info.mName ?? ""; }
