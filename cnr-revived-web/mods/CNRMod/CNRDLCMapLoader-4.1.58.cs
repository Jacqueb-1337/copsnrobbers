...
namespace CNRMods
{
    ...
    internal class CNRDLCMapLoader : MonoBehaviour
    {
        ...
        private static void RemapVanillaSpawnPoints()
        {
            ...
            RoomMultiplayerMenu[] menus = (RoomMultiplayerMenu[])UnityEngine.Object.FindObjectsOfType(typeof(RoomMultiplayerMenu));
            int remappedMenus = 0;
            ...
            ModEntry.Log("DLCMap: remapped vanilla spawn list(s)=" + remappedMenus + " points=" + targets.Count);
        }
