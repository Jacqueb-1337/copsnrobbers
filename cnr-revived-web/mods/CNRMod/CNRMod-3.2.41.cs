...
namespace CNRMods
{
    ...
    public class ModEntry
    {
        ...
        public const  string Version = "3.2.41";
    ...
    public class CNRSkinGridUI : MonoBehaviour
    {
        ...
        bool     _stylesBuilt;
        Texture2D _txBg, _txDark, _txBlue, _txGray, _txCellEquipped;
        ...
        void DrawGrid(float sw, float sh)
        {
            ...
            for (int i = 0; i < total; i++)
            {
                ...
                // Thumbnail: use rendered model preview if ready, else UV map fallback
                Texture2D thumb = (_thumbsReady && _thumbTex != null && i < _thumbTex.Length)
                    ? _thumbTex[i] : Hook.GetThumb(i);
