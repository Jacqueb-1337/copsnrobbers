...
namespace CNRMods
{
    ...
    public class CNRPreJoinGate : MonoBehaviour
    {
        ...
        private IEnumerator JoinRoomPreflightRoutine(RoomInfo room)
        {
            ...
            // Do not enter Photon until the advertised custom map is actually active locally.
            // The vanilla donor scene is only a bootstrap and must never become an accepted
            // fallback for a room that claims to be running a custom/DLC map.
        ...
        internal void CreateRoomWithCompatibility()
        {
            ...
            try
            {
                ...
                bool roomMapIsDlc = hasCustomMap && ((roomMapEntry != null && roomMapEntry.IsDlcMap) || CNRDLCMapLoader.IsActive);
                int maxPlayers = 8;
