...
namespace CNRMods
{
    ...
    public class CNRDLCWeaponRuntime : MonoBehaviour
    {
        ...
        private void ApplyBussinAmmoLevel(WeaponScript ws)
        {
            ...
            ws.ShotGun.fractions = 5;
            // Bussin' reload speed is half of the previous tuning, so the reload duration
            // doubles from 1.75x to 3.5x the donor shotgun's reload time.
            ws.ShotGun.reloadTime = Mathf.Max(0.1f, ws.ShotGun.reloadTime * 3.5f);
