    ...
    public class CNRMatchSettingsUIHook : MonoBehaviour
    {
        ...
        private void RebuildContent()
        {
            ...
            else if (_tab == 1)
            {
                ...
                string[] modes = new string[] { "tdm", "stronghold", "kc", "ctf", "zombies", "ffa" };
                float y = 0.145f;
            ...
            else if (_tab == 2)
            {
                ...
                else if (mode == "ffa")
                {
                    ...
                    {
                        AddBotTeamRow("Bot Count", s.KcBotCount, s.KcBotsAuto != 0, "kcbotcount", "kcbotauto", ref y);
                        MakeNativeLabel(_content.transform, "All players and bots are enemies. AUTO keeps the total population filled.", new Vector3(0f, y - 0.01f, -2f), _baseDepth + 30, 0.58f);
                    }
                }
                else if (mode == "ctf")
                {
