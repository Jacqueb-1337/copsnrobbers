...
namespace CNRMods
{
    ...
    internal class CNRMatchSettingsData
    {
        ...
        public int TdmCopBots = -1;             // -1 = AUTO fill team to 5 total players
        public int TdmRobberBots = -1;          // -1 = AUTO fill team to 5 total players
        public int KcBotsEnabled = 0;
        public int KcBotCount = 4;
    ...
    internal static class CNRMatchSettings
    {
        ...
        internal static string Pack(CNRMatchSettingsData d)
        {
            ...
            return d.Schema + "|" + NormalizeMode(d.Mode) + "|" + d.RoundSeconds + "|" + d.KcKillLimit + "|" +
                ...
                d.TdmBotsEnabled + "|" + d.TdmCopBots + "|" + d.TdmRobberBots + "|" + d.KcBotsEnabled + "|" + d.KcBotCount;
        }
            ...
            try
            {
                ...
                if (sourceSchema >= 2)
                {
                    if (p.Length < 15 ||
                        ...
                        !int.TryParse(p[12], out d.TdmRobberBots) ||
        ...
        internal static bool ValidateRanges(CNRMatchSettingsData d, out string reason)
        {
            ...
            if (d.TdmCopBots < -1 || d.TdmCopBots > 7 || d.TdmRobberBots < -1 || d.TdmRobberBots > 7) { reason = "TDM bot counts must be Auto or 0-7."; return false; }
        ...
        internal static void Sanitize(CNRMatchSettingsData d)
        {
            ...
            d.TdmCopBots = Mathf.Clamp(d.TdmCopBots, -1, 7);
            d.TdmRobberBots = Mathf.Clamp(d.TdmRobberBots, -1, 7);
