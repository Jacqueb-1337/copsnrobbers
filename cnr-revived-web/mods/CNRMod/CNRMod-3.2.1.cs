...
namespace CNRMods
{
    ...
    public class CNRSkinGridUI : MonoBehaviour
    {
        ...
        void DrawGrid(float sw, float sh)
        {
            ...
            // Grid layout – 3 columns, portrait model thumbnails (1.3:1)
            const int COLS = 3;
            float pad    = 10 * s;
        ...
        void BuildStyles()
        {
            ...
            _sHint.fontSize = Mathf.Max(10, (int)(12 * s));
