...
namespace CNRMods
{
    ...
    public class ModEntry
    {
        ...
        public const  string Version = "3.2.30";
    ...
    public class ContentManager : MonoBehaviour
    {
        ...
        static Texture2D NormalizePlayerSkin(Texture2D src)
        {
            if (src == null) return null;

            Texture2D dst = new Texture2D(64, 64, TextureFormat.ARGB32, false);
            dst.filterMode = FilterMode.Point;
            dst.wrapMode = TextureWrapMode.Clamp;
            Color32[] outPx = new Color32[64 * 64];
            ...
            int srcW = src.width;
            int srcH = src.height;
            System.Func<int,int,Color32> getPx = (x, y) =>
            {
                if (x < 0 || y < 0 || x >= srcW || y >= srcH) return transparent;
                int idx = y * srcW + x;
                if (idx < 0 || idx >= srcPx.Length) return transparent;
                return srcPx[idx];
            };
            BlitRectDelegate blit = (sx, sy, w, h, dx, dy, flipX, flipY) =>
            {
                for (int y = 0; y < h; y++)
                {
                    for (int x = 0; x < w; x++)
                    {
                        int rx = flipX ? (w - 1 - x) : x;
                        int ry = flipY ? (h - 1 - y) : y;
                        int tx = dx + x;
                        int ty = dy + y;
                        if (tx < 0 || ty < 0 || tx >= 64 || ty >= 64) continue;
                        outPx[ty * 64 + tx] = getPx(sx + rx, sy + ry);
                    }
                }
            };

            // Base layer, same packing as the editor's player import.
            blit( 8,  8,  8,  8,  8,  0, false, false);
            blit( 0,  8,  8,  8, 16,  0, false, false);
            blit(16,  8,  8,  8,  0,  0, false, false);
            blit(24,  8,  8,  8, 24,  0, false, false);
            blit( 8,  0,  8,  8, 32,  0, false, false);
            blit(16,  0,  8,  8, 40,  0, false, false);
            blit(20, 20,  8, 12,  4,  8, false, false);
            blit(28, 20,  4, 12,  0,  8, false, false);
            blit(16, 20,  4, 12, 12,  8, false, false);
            blit(32, 20,  8, 12, 16,  8, false, false);
            blit(20, 16,  8,  4, 24,  8, false, false);
            blit(28, 16,  8,  4, 24, 12, false, false);
            blit(44, 20,  4, 12,  4, 20, false, false);
            blit(48, 20,  4, 12,  8, 20, false, false);
            blit(40, 20,  4, 12,  0, 20, false, false);
            blit(52, 20,  4, 12, 12, 20, false, false);
            blit(44, 16,  4,  4, 16, 20, false, false);
            blit(48, 16,  4,  4, 16, 24, false, false);
            blit( 4, 20,  4, 12, 20, 20, false, false);
            blit( 0, 20,  4, 12, 24, 20, false, false);
            blit( 8, 20,  4, 12, 28, 20, false, false);
            blit(12, 20,  4, 12, 32, 20, false, false);
            blit( 4, 16,  4,  4, 36, 20, false, false);
            blit( 8, 16,  4,  4, 36, 24, false, false);

            if (srcH >= 64)
            {
                // 64x64 layer data from the editor's player import.
                blit(40,  8, 8,  8,  8, 32, false, false);
                blit(32,  8, 8,  8, 16, 32, false, false);
                blit(48,  8, 8,  8,  0, 32, false, false);
                blit(56,  8, 8,  8, 24, 32, false, false);
                blit(40,  0, 8,  8, 32, 32, false, false);
                blit(48,  0, 8,  8, 40, 32, false, false);
                blit(20, 36, 8, 12,  4, 40, false, false);
                blit(28, 36, 4, 12,  0, 40, false, false);
                blit(16, 36, 4, 12, 12, 40, false, false);
                blit(32, 36, 8, 12, 16, 40, false, false);
                blit(20, 32, 8,  4, 24, 40, false, false);
                blit(28, 32, 8,  4, 24, 44, false, false);
                blit(44, 36, 4, 12,  4, 52, false, false);
                blit(40, 36, 4, 12,  0, 52, false, false);
                blit(48, 36, 4, 12,  8, 52, false, false);
                blit(52, 36, 4, 12, 12, 52, false, false);
                blit(44, 32, 4,  4, 16, 52, false, false);
                blit(48, 32, 4,  4, 16, 56, false, false);
                blit( 4, 36, 4, 12, 20, 52, false, false);
                blit( 0, 36, 4, 12, 24, 52, false, false);
                blit( 8, 36, 4, 12, 28, 52, false, false);
                blit(12, 36, 4, 12, 32, 52, false, false);
                blit( 4, 32, 4,  4, 36, 52, false, false);
                blit( 8, 32, 4,  4, 36, 56, false, false);

                blit(36, 52, 4, 12,  4, 52, false, false);
                blit(32, 52, 4, 12,  0, 52, false, false);
                blit(40, 52, 4, 12,  8, 52, false, false);
                blit(44, 52, 4, 12, 12, 52, false, false);
                blit(36, 48, 4,  4, 16, 52, false, false);
                blit(40, 48, 4,  4, 16, 56, false, false);
                blit(20, 52, 4, 12, 20, 52, false, false);
                blit(16, 52, 4, 12, 24, 52, false, false);
                blit(24, 52, 4, 12, 28, 52, false, false);
                blit(28, 52, 4, 12, 32, 52, false, false);
                blit(20, 48, 4,  4, 36, 52, false, false);
                blit(24, 48, 4,  4, 36, 56, false, false);
            }
    ...
    public class CNRRemoteSkinRenderer : MonoBehaviour
    {
        ...
        bool ApplyToTransform(Transform root, Texture2D tex)
        {
            ...
            if (tex != null && tex.width == 64 && tex.height == 64)
            {
                ...
                {
                    cached = MakeLegacySkinBase(tex);
                    if (cached != null) _baseSkinCache[key] = cached;
                }
                if (cached != null) useTex = cached;
            }
        ...
        static Texture2D MakeLegacySkinBase(Texture2D src)
        {
            if (src == null || src.width != 64 || src.height != 64) return null;
            ...
            for (int y = 0; y < 32; y++)
            {
                ...
                {
                    int idx = y * 64 + x;
                    if (idx >= 0 && idx < srcPx.Length) outPx[idx] = srcPx[idx];
                }
            }
            dst.SetPixels32(outPx);
            dst.Apply(false, false);
