...
namespace CNRMods
{
    ...
    internal class CNRMinecraftWaterController : MonoBehaviour
    {
        ...
        private const float SwimExitSubmersion = -0.22f;
        private const float SurfaceRiseCutoff = 0.06f;
        ...
        void LateUpdate()
        {
            ...
            if (jumpHeld && rawSubmersion > SurfaceRiseCutoff)
            {
            ...
            else if (rawSubmersion <= SurfaceRiseCutoff)
            {
                // Once the player's feet crest the surface, stop applying swim thrust and
