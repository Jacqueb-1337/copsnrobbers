...
namespace CNRMods
{
    ...
    {
        private const string ThumbnailFile = "bussin_thumb_v3.png";
        private const string ThumbnailHashPref = "CNR_BussinThumbHashV3";
        ...
        private static GameObject BuildPreviewModel()
        {
            ...
            if (data.uv != null)
            {
                ...
                for (int i = 0; i < uvCount; i++) sourceUv[i] = new Vector2(data.uv[i * 2], data.uv[i * 2 + 1]);
            }
