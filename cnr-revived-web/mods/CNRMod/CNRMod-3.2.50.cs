...
namespace CNRMods
{
    ...
    public class ModEntry
    {
        ...
        public const  string Version = "3.2.50";
    ...
    public class CnrModeButton : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (_isCTF)
                ...
                isChecked = ZombieMode.PendingZombie || ZombieMode.IsZombieRoom || (msd.curModeSet == _modeTag && !ZombieMode.PendingZombie);
            else
    ...
    public class ZombieCheckBoxInjector : MonoBehaviour
    {
        ...
        private bool TryInject()
        {
            ...
            _source = msd.mModeCheckBoxTDM;
            if (_source == null) return false;

            Vector3 tdmPos = _source.transform.localPosition;
            Vector3 zombiePos = new Vector3(tdmPos.x, tdmPos.y - 0.2f, tdmPos.z);
