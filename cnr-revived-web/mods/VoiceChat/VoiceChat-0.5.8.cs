    ...
    public class VoiceChatHook : MonoBehaviour
    {
        ...
        private void MaybeBroadcastVoiceRoom()
        {
            try
            {
                ...
                ht["room"] = room;
                ht["scene"] = SceneName();
                VoiceChatEntry.Log("Voice room send code=" + VoiceChatEntry.VoiceRoomEvent + " keys=" + DumpHashtableKeys(ht) + " room=" + room);
        ...
        private void MaybeReportState()
        {
            try
            {
                ...
                if (scene == _lastReportedScene && room == _lastReportedRoom) return;
        ...
        private void ReportState(string scene, string room)
        {
            try
            {
                ...
                string text = "state scene=" + scene + " room=" + room + " peer=" + peer + " name=" + name + " mic=" + mic + " devices=" + devs + " web=" + (_webRtcSupported ? "1" : "0") + " bridge=" + bridge + " peers=" + peers;
