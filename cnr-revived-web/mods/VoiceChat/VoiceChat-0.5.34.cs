    ...
    public class WebRtcBridge
    {
        ...
        private void AndroidShowNativeWebView(string url)
        {
            ...
            if (_nativeWebContainer == null)
            {
                ...
                SafeCall(_nativeWebContainer, "setPadding", 12, 74, 12, 12);
        ...
        private void ShowPopupWebView(AndroidJavaObject activity)
        {
            ...
            {
                int matchParent = -1;
                _nativePopupWindow = new AndroidJavaObject("android.widget.PopupWindow", _nativeWebContainer, matchParent, matchParent, true);
                ...
                _nativePopupWindow.Call("showAtLocation", decor, 0, 0, 0);
                _nativeWebViewAdded = true;
                VoiceChatEntry.Log("Native WebView popup shown");
            }
            catch (Exception ex)
            {
