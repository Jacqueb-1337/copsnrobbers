...
namespace CNRVoiceChat
{
    ...
    public class WebRtcBridge
    {
        ...
        private void AndroidShowNativeWebView(string url)
        {
            ...
            if (_nativeWebView == null)
            {
                ...
                SafeCall(_nativeWebView, "setOnTouchListener", new TouchEaterProxy());
            ...
            if (_nativeWebContainer == null)
            {
                ...
                SafeCall(_nativeWebContainer, "setOnTouchListener", new TouchEaterProxy());
            ...
            if (_nativeWebContainer != null && _nativeWebView != null)
            {
                try
                {
                    AndroidJavaObject childLp = CreateNativeLayoutParams();
            ...
            {
                AndroidJavaObject lp = CreateNativeLayoutParams();
                activity.Call("addContentView", _nativeWebContainer, lp);
                _nativeWebViewAdded = true;
                VoiceChatEntry.Log("Native WebView added to activity");
            }
    ...
    public class TouchEaterProxy : AndroidJavaProxy
    {
        public TouchEaterProxy() : base("android.view.View$OnTouchListener")
        {
        }
