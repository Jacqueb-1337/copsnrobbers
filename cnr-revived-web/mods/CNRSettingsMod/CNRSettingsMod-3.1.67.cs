...
namespace CNRSettingsMod
{
    ...
    public class SettingsModHook : MonoBehaviour
    {
        ...
        private void UpdateScene(string scene)
        {
            ...
            try { Type t = EcoType(); if (t != null) { var fi = t.GetField("ModManagerOpen", BindingFlags.Public | BindingFlags.Static); if (fi != null) fi.SetValue(null, false); } } catch { }
            _nguiCam          = null;
            _pausePanelRef    = null;
            _pauseUIPanel     = null;
        ...
        public void OpenSettings()
        {
            ...
            if (_showSettings)
            {
                ...
                try { Type t = EcoType(); if (t != null) { var fi = t.GetField("ModManagerOpen", BindingFlags.Public | BindingFlags.Static); if (fi != null) fi.SetValue(null, true); } } catch { }
