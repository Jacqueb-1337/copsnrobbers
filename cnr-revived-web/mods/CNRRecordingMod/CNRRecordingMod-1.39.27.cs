...
namespace CNRRecordingMod
{
    ...
    public static class RecordingModEntry
    {
        ...
        public  const string Version = "1.39.27";
    ...
    public class RecordingHook : MonoBehaviour
    {
        ...
        private void Start()
        {
            // OnLevelWasLoaded does not fire for the scene the mod loads INTO.
            // Run the button hook here so it works on the initial MainMenu load.
