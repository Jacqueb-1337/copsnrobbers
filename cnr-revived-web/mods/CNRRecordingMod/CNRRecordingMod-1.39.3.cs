...
namespace CNRRecordingMod
{
    ...
    public static class RecordingModEntry
    {
        ...
        public  const string Version = "1.39.3";
            ...
            try
            {
                ...
                for (int f = 0; f < _capturedFrames; f++)
                {
                    ...
                    if (inIdx >= 0)
                    {
                        ...
                        // ByteBuffer.put(byte[]) fills the buffer from position 0.
                        // Do NOT call rawBuf.Call("clear") — clear() returns Buffer not void,
                        // so Unity 4.6 JNI throws NoSuchMethodError looking for clear()V.
                        // getInputBuffer() always returns a buffer with position=0.
