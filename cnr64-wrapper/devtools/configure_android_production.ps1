param(
    [string]$BuildDir = "build-android-arm64-production"
)
...
cmake -S . -B $BuildDir -G Ninja `
    ...
    -DPROJECTV7_DEV_DIAGNOSTICS=OFF
if ($LASTEXITCODE -ne 0) { throw 'ProjectV7 production configure failed.' }

Write-Host "PROJECTV7 PRODUCTION BUILD CONFIGURED: $BuildDir"
Write-Host 'Live hotpatch/plugin loading is DISABLED and omitted from this build.'
