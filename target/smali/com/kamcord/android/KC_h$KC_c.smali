.class final Lcom/kamcord/android/KC_h$KC_c;
...
.field private synthetic b:Lcom/kamcord/android/KC_h;


# direct methods
.method constructor <init>(Lcom/kamcord/android/KC_h;I)V
    .locals 0

    iput-object p1, p0, Lcom/kamcord/android/KC_h$KC_c;->b:Lcom/kamcord/android/KC_h;

    invoke-direct {p0}, Landroid/os/AsyncTask;-><init>()V

    iput p2, p0, Lcom/kamcord/android/KC_h$KC_c;->a:I
...
.method private varargs a([Ljava/lang/String;)Ljava/lang/String;
    ...
    iget v3, p0, Lcom/kamcord/android/KC_h$KC_c;->a:I

    packed-switch v3, :pswitch_data_0

    new-instance v0, Ljava/lang/StringBuilder;

    const-string v2, "No validate task type "

    invoke-direct {v0, v2}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget v2, p0, Lcom/kamcord/android/KC_h$KC_c;->a:I

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string v2, " for getting response."
    ...
    const-string v0, "validateUsernameUser"
    ...
    const-string v3, " in validate task."
    ...
    const-string v0, "validateEmailUser"
    ...
    :goto_2
    const-string v2, "Error in validate task."
...
.method protected final synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1}, Lcom/kamcord/android/KC_h$KC_c;->a([Ljava/lang/String;)Ljava/lang/String;
...
.method protected final synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    iget v1, p0, Lcom/kamcord/android/KC_h$KC_c;->a:I

    packed-switch v1, :pswitch_data_0

    new-instance v0, Ljava/lang/StringBuilder;

    const-string v1, "No validate task type "
    ...
    const-string v1, " for parsing response."
    ...
    :pswitch_0
    iget-object v1, p0, Lcom/kamcord/android/KC_h$KC_c;->b:Lcom/kamcord/android/KC_h;

    invoke-static {v1}, Lcom/kamcord/android/KC_h;->a(Lcom/kamcord/android/KC_h;)Landroid/widget/EditText;

    move-result-object v1

    const-string v2, "validateUsernameUser"
    ...
    const-string v1, "Error parsing response from validate task."
    ...
    const-string v2, "validateEmailUser"
    ...
    const-string v0, "Null response string from validate task."
